            ...
            <form class="needs-validation" id="form_tambah" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="tambah_name" class="form-control" name="name" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" id="tambah_email" class="form-control" name="email" required
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="password" id="tambah_password" minlength="8" class="form-control"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tambah_password_confirmation">Password Confirmation</label>
                                <input type="password" id="tambah_password_confirmation" minlength="8"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tambah_select_roles">Roles</label>
                                <select name="roles" id="tambah_select_roles" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
                                <label for="tambah_select_permissions">Permission</label>
