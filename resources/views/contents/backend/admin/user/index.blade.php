...
@section('breadcumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('backend.admin.user.index') }}">User</a></li>
    </ol>
@endsection
...
@section('content')
    ...
    <!-- Modal -->
    @include('contents.backend.admin.user.modal.tambah')
    @include('contents.backend.admin.user.modal.ubah')
@endsection

@push('scripts')
    @include('contents.backend.admin.user.index_js')
@endpush
