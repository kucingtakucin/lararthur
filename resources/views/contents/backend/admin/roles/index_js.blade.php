<script>
    ...
    $(() => {
        ...
        datatable = $('#table_data').DataTable({
            ...
            ajax: {
                url: "{{ route('backend.admin.roles.data') }}",
                type: 'GET',
                dataType: 'JSON',
                data: {},
                beforeSend: () => {
            ...
            columns: [{ // 0
                ...
                { // 5
                    title: 'Created At',
                    name: 'roles.created_at', // Table.column -> Untuk menghindari order clause is ambiguous
                    data: 'created_at',
                }
            ],
        ...
        $insert = (form) => {
            ...
            axios.post("{{ route('backend.admin.m.insert') }}", formData)
                .then(res => {
        ...
        $update = (form) => {
            ...
            axios.post("{{ route('backend.admin.roles.update') }}", formData)
                .then(res => {
        ...
        $delete = (element) => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    status_crud = true
                    axios.post("{{ route('backend.admin.roles.delete') }}", formData)
                        .then(res => {
