                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="tambah_nim" class="form-control" name="nim" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="tambah_nama" class="form-control" name="nama" required
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="fakultas_id" id="tambah_select_fakultas" required
                                    class="form-control select_fakultas">
                                    <option></option>
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="prodi_id" id="tambah_select_prodi" class="form-control select_prodi"
                                    required disabled>
                                    <option></option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="tambah_foto" required
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="tambah_latitude" class="form-control" name="latitude" required
