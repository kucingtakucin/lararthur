        ...
        <div class="modal-content">
            <form class="needs-validation" id="form_ubah" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ubah_nim" class="form-control" name="nim" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ubah_nama" class="form-control" name="nama" required
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="ubah_angkatan" class="form-control" name="angkatan" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="fakultas_id" id="ubah_select_fakultas" required
                                    class="form-control select_fakultas"></select>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="prodi_id" id="ubah_select_prodi" class="form-control select_prodi"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="ubah_foto"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ubah_latitude" class="form-control" name="latitude" required
                                    autocomplete="off" placeholder="Masukkan Latitude">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="ubah_longitude" class="form-control" name="longitude" required
                    ...
                    <input type="hidden" id="ubah_old_foto">
                </div>
