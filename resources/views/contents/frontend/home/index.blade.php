            ...
            <div id="slider10" class="rev_slider fullwidthbanner" data-version="5.4.7">
                <ul>
                    <li data-transition="fade" data-thumb=""><img
                            src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/slider-bg12.jpg"
                            alt="" />
...
@section('content')
    ...
    <div class="wrapper white-wrapper">
        <div class="container inner">
            ...
            <div class="row gutter-60 text-center align-items-end">
                <div class="col-md-4">
                    <figure class="mb-30"><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept14.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept14@2x.png 2x"
                            alt="" /></figure>
                    <h4>Social Media</h4>
                    <p class="mb-15">Maecenas faucibus mollis interdum. Cum sociis natoque penatibus et magnis dis
                ...
                <div class="col-md-4">
                    <figure class="mb-30"><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept19.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept19@2x.png 2x"
                            alt="" /></figure>
                ...
                <div class="col-md-4">
                    <figure class="mb-30"><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept18.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept18@2x.png 2x"
                            alt="" /></figure>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <figure><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept15.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept15@2x.png 2x"
                            alt="" /></figure>
                </div>
                <!--/column -->
                <div class="space20 d-md-none"></div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2 text-center">
                    <figure><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept17.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept17@2x.png 2x"
                            alt="" /></figure>
                </div>
                <!--/column -->
                <div class="space20 d-md-none"></div>
                    ...
                    <div id="accordion-1" class="accordion-wrapper simple">
                        <div class="card">
                            <div class="card-header" id="accordion-heading-1-1">
                                <h5>
                                    <button data-toggle="collapse" data-target="#accordion-collapse-1-1"
                                        aria-expanded="true" aria-controls="accordion-collapse-1-1">Money
                                        Protection</button>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <div class="card-header" id="accordion-heading-1-2">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-2"
                                        aria-expanded="false" aria-controls="accordion-collapse-1-2">Strategic
                                        Development</button>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <div class="card-header" id="accordion-heading-1-3">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-1-3"
                                        aria-expanded="false" aria-controls="accordion-collapse-1-3">Marketing
                                        Management</button>
                                </h5>
                            </div>
                            <!-- /.card-header -->
    ...
    <div class="wrapper image-wrapper bg-image gradient-overlay inverse-text"
        data-image-src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/bg25.jpg">
        ...
        <div class="container inner">
            ...
            <div class="grid-view">
                <div class="carousel owl-carousel" data-margin="30" data-dots="true" data-autoplay="false"
                    ...
                    <div class="item">
                        <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img
                                    src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/b1.jpg"
                                    alt="" /></a>
                            <figcaption>
                                <h5 class="from-top mb-0">Read More</h5>
                            </figcaption>
                        </figure>
                        <h2 class="post-title mb-0"><a href="blog-post.html">Ligula tristique quis risus eget urna mollis
                                ornare porttitor</a></h2>
                    </div>
                    <!-- /.item -->
                    <div class="item">
                        <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img
                                    src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/b2.jpg"
                                    alt="" /></a>
                            <figcaption>
                                <h5 class="from-top mb-0">Read More</h5>
                            </figcaption>
                    ...
                    <div class="item">
                        <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img
                                    src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/b3.jpg"
                                    alt="" /></a>
                            <figcaption>
                                <h5 class="from-top mb-0">Read More</h5>
                            </figcaption>
                    ...
                    <div class="item">
                        <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img
                                    src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/b4.jpg"
                                    alt="" /></a>
                            <figcaption>
                                <h5 class="from-top mb-0">Read More</h5>
                            </figcaption>
                    ...
                    <div class="item">
                        <figure class="overlay overlay1 rounded mb-30"><a href="#"> <img
                                    src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/b5.jpg"
                                    alt="" /></a>
                            <figcaption>
                                <h5 class="from-top mb-0">Read More</h5>
                            </figcaption>
                        </figure>
                        <h2 class="post-title mb-0"><a href="blog-post.html">Mollis adipiscing lorem quis mollis eget
                                lacinia faucibus</a></h2>
                    </div>
                    <!-- /.item -->
                </div>
                <!-- /.owl-carousel -->
    ...
    <div class="wrapper white-wrapper">
        <div class="container inner">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 pr-60 pr-md-15">
                    <figure><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept16.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept16@2x.png 2x"
                            alt="" /></figure>
                </div>
                <!--/column -->
                <div class="space20 d-md-none"></div>
                ...
                <div class="col-lg-5">
                    <div class="basic-slider owl-carousel gap-small dots-left" data-margin="30">
                        <div class="item">
                            <blockquote class="icon icon-left larger text-left">
                                <p>"Sed posuere consectetur est at lobortis. Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Duis mollis, est non commodo luctus, nisi cras mattis consectetur purus
                                    posuere."</p>
                        ...
                        <div class="item">
                            <blockquote class="icon icon-left larger text-left">
                                <p>"Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. Vestibulum id
                                    ligula porta felis euismod semper. Cras justo odio, posuere consectetur est at
                                    lobortis."</p>
                                <div class="blockquote-details">
                                    <div class="info p-0">
                        ...
                        <div class="item">
                            <blockquote class="icon icon-left larger text-left">
                                <p>"Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem
                                    nec elit. Cras justo odio, dapibus ac facilisis in, egestas eget posuere consectetur est
                                    at lobortis."</p>
                                <div class="blockquote-details">
                                    <div class="info p-0">
            ...
            <div class="carousel owl-carousel clients" data-margin="30" data-loop="true" data-dots="false"
                ...
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z1.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z2.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z3.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z4.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z5.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z6.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z7.svg" alt="" />
                </div>
                <div class="item pl-15 pr-15"><img
                        src="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/art/z8.svg" alt="" />
                </div>
            </div>
            <!-- /.owl-carousel -->
        </div>
        ...
        <div class="container inner">
            ...
            <div class="row">
                <div class="col-lg-5 pr-50 pr-md-15">
                    ...
                    <div class="space20"></div>
                    <p>Nulla vitae elit libero, a pharetra augue. Donec ullamcorper nulla non metus auctor fringilla.
                        Maecenas sed diam eget risus varius blandit sit amet non magna. Nulla vitae elit libero, a pharetra
                        augue. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Sed posuere consectetur est. Sed
            ...
            <div class="row">
                <div class="col-lg-6">
                    <figure><img src="#"
                            srcset="https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept13.png 1x, https://appt.demoo.id/tema/snowlake/snowlake-html/snowlake/style/images/concept/concept13@2x.png 2x"
                            alt="" /></figure>
                </div>
                <!--/column -->
                <div class="space50 d-none d-md-block d-lg-none"></div>
                ...
                <div class="col-lg-6 pl-60 pl-md-15">
                    ...
                    <div class="space10"></div>
                    <h3 class="display-3">If you don't see an answer to your question, you can send us an email from our
                        contact form.</h3>
                    <div class="space20"></div>
                            ...
                            <div class="card-header" id="accordion-heading-2-2">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-2-2"
                                        aria-expanded="false" aria-controls="accordion-collapse-2-2">Which payment methods
                                        do you accept?</button>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <div class="card-header" id="accordion-heading-2-3">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-2-3"
                                        aria-expanded="false" aria-controls="accordion-collapse-2-3">How can I manage my
                                        Account?</button>
                                </h5>
                            </div>
                            <!-- /.card-header -->
                            ...
                            <div class="card-header" id="accordion-heading-2-4">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-2-4"
                                        aria-expanded="false" aria-controls="accordion-collapse-2-4">Is my credit card
                            ...
                            <div class="card-header" id="accordion-heading-2-5">
                                <h5>
                                    <button class="collapsed" data-toggle="collapse" data-target="#accordion-collapse-2-5"
                                        aria-expanded="false" aria-controls="accordion-collapse-2-5">How do I get my
