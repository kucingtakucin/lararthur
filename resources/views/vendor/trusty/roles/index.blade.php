...
@section('breadcumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('trusty.roles.index') }}">Roles</a></li>
    </ol>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="text-center">Kelola Data Roles</h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="text-right mb-3">
                        <a href="{{ route('trusty.roles.create') }}" class="btn btn-primary"><em
                                class="fa fa-plus"></em>
                            New Role</a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover" id="roles-table">
                        ...
                        <tbody>
                            @foreach ($roles as $item)
                                <tr>
                                    <td>{{ $item->id }}</td>
                                    <td><a href="{{ route('trusty.roles.show', $item) }}">{{ $item->name }}</a>
                                    </td>
